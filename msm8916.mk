...
PRODUCT_COPY_FILES +=  \
    ...
    frameworks/av/services/audiopolicy/config/r_submix_audio_policy_configuration.xml:s$(TARGET_COPY_OUT_VENDOR)/etc/r_submix_audio_policy_configuration.xml \
